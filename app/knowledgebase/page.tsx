        ...
        <main className="flex-1 overflow-y-auto bg-accent/5">
          <div className="container mx-auto py-8 px-6">
            <div className="max-w-7xl mx-auto space-y-8">
                  ...
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-5">
                    <nav className="w-full sm:w-auto overflow-x-auto">
                      <Tabs 
                        ...
                        className="w-full"
                      >
                        <TabsList className="bg-muted/50 p-1.5 rounded-lg">
                          {categories.map((category) => (
                            <TabsTrigger 
                              key={category} 
                              value={category} 
                              className="capitalize data-[state=active]:bg-background relative px-4 py-2 transition-all duration-200"
                            >
                              {category}
                              {category !== 'All' && (
                                <span className="absolute -top-1 -right-1 bg-primary text-[10px] text-primary-foreground rounded-full px-1.5 py-0.5 shadow-sm">
                    ...
                    <Link href="/knowledgebase/new-article">
                      <Button className="w-full sm:w-auto shadow-sm hover:shadow group bg-primary text-primary-foreground hover:bg-primary/90 rounded-lg transition-all duration-200">
              ...
              {/* Tags */}
              <div className="bg-card rounded-xl shadow-sm overflow-hidden border border-border/40">
                <div className="border-b border-border/40 px-6 py-4 flex justify-between items-center">
                  ...
                  <div className="flex flex-wrap gap-2.5">
                    {tags.map((tag) => (
                      <Badge
                        ...
                        className={`cursor-pointer px-3.5 py-1.5 transition-all duration-200 ${
                          selectedTag === tag 
